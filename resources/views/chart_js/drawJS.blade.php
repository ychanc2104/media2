    ...
    <script type="text/javascript">
        ...
        function show_chart(chart_data, keys, col_name, id) {
            ...
            //     // only deal with click charts with three input
            //     if (keys.length == 3){
            //         data.addRow([x_axis[i], JSON.parse(chart_data)[keys[0]][i], JSON.parse(chart_data)[keys[1]][i], JSON.parse(chart_data)[keys[2]][i]]);
            //     } else {
            //         data.addRow([x_axis[i], JSON.parse(chart_data)[keys[0]][i]]);
            //     }
            // } 
